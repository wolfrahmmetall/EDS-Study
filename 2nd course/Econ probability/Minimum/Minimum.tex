...
\begin{itemize}
    \item[\textbf{а)}] $\Omega = \{X=-1\} + \{X = 0\} + \{X = 1\} \text{ и } 1 = \{X=-1\} + \{X=0\} + \{X=1\} \implies c = 0.5$
    \item[\textbf{б)}]  $\mathbb{P}\{X=0\} = \mathbb{P}(\{X=-1\}\sqcup\{X=1\}) = \mathbb{P}(\{X=0\}) + \mathbb{P}(\{X=1\}) = 0.75$
    \item[\textbf{в)}]  $\mathbb{P}(\{X<-3\}) = 0$, т.к. $\{X<-3\} = \{\omega\in \Omega: X(\omega)<-3\}$
    \item[\textbf{г)}]  $\mathbb{P}(\{X\in [-0.5;0.5]\}) = \mathbb{P}(\{X=0\}) = 0.5$
\end{itemize}
...
\begin{itemize}
    \item[\textbf{а)}] $F_X(-100) = \mathbb{P}(\{\omega\in\Omega:\xi(\omega)\leqslant -100\}) = 0$
